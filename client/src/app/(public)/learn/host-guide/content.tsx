...
const ScannerSetupVisual = () => (
  <div className="mt-4 space-y-4">
     ...
     {/* Mock UI */}
     <div className="relative bg-white rounded-xl border border-neutral-200 shadow-sm overflow-hidden w-full max-w-[400px] select-none">
        {/* Browser Top Bar */}
        <div className="bg-neutral-50 px-3 py-2 border-b border-neutral-200 flex items-center gap-2">
            ...
            <div className="mx-auto text-[10px] text-neutral-400 font-medium bg-white px-2 py-0.5 rounded border border-neutral-100 shadow-sm truncate max-w-[150px] sm:max-w-none">
        ...
        <div className="p-5 flex flex-col gap-4">
            {/* Tabs */}
            <div className="flex gap-4 border-b border-neutral-100 pb-2 overflow-x-auto hide-scrollbar">
                <div className="w-12 h-2 bg-neutral-200 rounded-full shrink-0"></div>
                <div className="w-16 h-2 bg-brand-100 rounded-full relative shrink-0">
                    <div className="absolute -bottom-2.5 left-0 right-0 h-0.5 bg-brand-500"></div>
                </div>
                <div className="w-10 h-2 bg-neutral-200 rounded-full shrink-0"></div>
            </div>
            ...
            <div className="bg-neutral-50 rounded-lg p-4 border border-neutral-100 flex flex-col items-center gap-3 text-center">
                ...
                <div className="relative">
                    ...
                    {/* Cursor Pointer */}
                    <div className="absolute top-1/2 -right-12 -translate-y-1/2 flex items-center animate-pulse hidden sm:flex">
...
const ExportPDFVisual = () => (
  <div className="mt-4 space-y-4">
     ...
     <div className="bg-white rounded-[24px] border border-neutral-100 shadow-sm p-4 w-full max-w-[380px] select-none relative overflow-hidden">
        <div className="flex items-center justify-between mb-4">
           <h3 className="text-sm font-normal tracking-wider text-neutral-700">Event Status</h3>
           <div className="flex items-center gap-1.5 px-2 py-0.5 bg-emerald-50 rounded-full shrink-0">
        ...
        <div className="grid grid-cols-2 gap-3">
           <div className="p-3 rounded-xl border border-neutral-100 bg-neutral-50 flex items-center justify-between opacity-50">
              <div className="flex items-center gap-2 overflow-hidden">
                 <div className="w-4 h-4 rounded-full border-2 border-neutral-300 shrink-0"></div>
                 <span className="text-[8px] uppercase tracking-widest text-neutral-500 truncate">Pause Sales</span>
              </div>
           </div>
           ...
           <div className="relative group cursor-pointer">
               ...
               <div className="relative p-3 rounded-xl border border-brand-100 bg-brand-50 flex items-center justify-between">
                  <div className="flex items-center gap-2 overflow-hidden">
                     <div className="text-brand-600 shrink-0"><MousePointer2 size={14} className="-rotate-90" /></div>
                     <span className="text-[8px] uppercase tracking-widest text-brand-700 font-bold truncate">Export Tickets</span>
                  </div>
                  <ArrowRight size={10} className="text-brand-400 shrink-0" />
               </div>
               
               {/* Tooltip */}
               <div className="absolute -top-8 left-1/2 -translate-x-1/2 bg-neutral-800 text-white text-[9px] py-1 px-2 rounded shadow opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap hidden sm:block">
    ...
    <div className="text-sm text-neutral-600 space-y-2">
       <div className="flex gap-3">
          ...
          <div className="pb-4 min-w-0">
             ...
             <div className="bg-brand-50 rounded-xl border border-neutral-100 p-4 w-full max-w-[320px] select-none">
                 <div className="mb-2 text-[10px] font-medium text-neutral-500 uppercase tracking-wider">Scanner Session</div>
                 <div className="bg-white border border-neutral-200 rounded-lg p-2.5 flex items-center justify-between mb-2 gap-2">
                     <span className="text-xs text-neutral-400 font-mono truncate flex-1">https://scanner.zenvy...</span>
                     <div className="p-1.5 bg-neutral-100 rounded hover:bg-neutral-200 text-neutral-500 shrink-0">
                         <MousePointer2 size={12} />
                     </div>
                 </div>
       ...
       <div className="flex gap-3">
          ...
          <div className="pb-4 min-w-0">
             ...
             <div className="mt-2 inline-block px-3 py-1.5 bg-neutral-100 text-neutral-600 font-mono text-xs rounded border border-neutral-200 max-w-full truncate">
       ...
       <div className="flex gap-3">
          ...
          <div className="pb-4 min-w-0">
             ...
             <div className="bg-white rounded-xl border border-neutral-200 shadow-sm p-4 w-full max-w-[320px] select-none">
                 <div className="flex justify-between items-center gap-2">
                     <div className="min-w-0">
                         <div className="text-xs font-medium text-neutral-900 truncate">Connected Devices</div>
                         <div className="text-[10px] text-neutral-400 truncate">0 / 5 Devices Online</div>
                     </div>
                     <div className="flex items-center gap-1 pl-3 pr-2 py-1.5 bg-white border border-neutral-200 rounded-lg shadow-sm hover:bg-neutral-50 shrink-0">
       ...
       <div className="flex gap-3">
          ...
          <div className="pb-4 min-w-0">
             ...
             {/* Mock OTP Modal */}
             <div className="bg-white rounded-xl border border-neutral-200 shadow-lg p-5 w-full max-w-[280px] select-none relative">
    ...
    <div className="text-sm text-neutral-600 space-y-2">
       <div className="flex gap-3">
          ...
          <div className="pb-4 min-w-0">
             ...
             {/* Mock Header */}
             <div className="bg-white rounded-xl border border-neutral-200 shadow-sm p-3 w-full max-w-[320px] select-none">
                 <div className="flex justify-between items-center">
                    <div className="min-w-0">
                        <div className="text-[10px] uppercase tracking-widest text-neutral-400 font-bold truncate">Manual Action</div>
                        <div className="text-sm font-medium text-neutral-700 truncate">Verify & Check-in</div>
                    </div>
       ...
       <div className="flex gap-3 pb-28">
          ...
          <div className="pb-4 min-w-0">
             ...
             <div className="bg-white rounded-xl border border-neutral-200 shadow-sm p-4 w-full max-w-[320px] select-none relative">
                 ...
                 <div className="absolute top-[60px] left-0 right-0 bg-white border border-neutral-200 rounded-lg shadow-lg z-10 overflow-hidden">
                     <div className="px-3 py-2 bg-neutral-50 hover:bg-neutral-100 border-l-4 border-brand-500 flex justify-between items-center cursor-pointer gap-2">
                         <div className="min-w-0">
                             <div className="text-xs font-mono font-bold text-neutral-800 truncate">T-8294-A1B2</div>
                             <div className="text-[10px] text-neutral-500 truncate">John Doe • VIP</div>
                         </div>
                         <div className="px-1.5 py-0.5 bg-blue-50 text-blue-600 text-[8px] font-bold rounded uppercase shrink-0">Not Checked In</div>
                     </div>
                     <div className="px-3 py-2 hover:bg-neutral-50 flex justify-between items-center cursor-pointer border-t border-neutral-50 opacity-50 gap-2">
                         <div className="min-w-0">
                             <div className="text-xs font-mono font-bold text-neutral-800 truncate">T-9921-A1B2</div>
                             <div className="text-[10px] text-neutral-500 truncate">Jane Smith • GA</div>
                         </div>
                         <div className="px-1.5 py-0.5 bg-green-50 text-green-600 text-[8px] font-bold rounded uppercase shrink-0">Checked In</div>
                     </div>
                 </div>
             </div>
          </div>
          ...
          <div className="pb-4 min-w-0">
             ...
             <div className="bg-white rounded-xl border border-neutral-200 shadow-sm p-4 w-full max-w-[320px] select-none">
                 <div className="flex gap-3 mb-3">
                     <div className="w-8 h-8 rounded-full bg-emerald-100 flex items-center justify-center text-emerald-600 shrink-0"><CheckCircle2 size={16} /></div>
                     <div className="min-w-0">
                         <div className="px-2 py-0.5 bg-emerald-100 text-emerald-700 text-[8px] font-bold rounded uppercase w-fit mb-1">Valid</div>
                         <div className="text-xs font-medium text-neutral-800 truncate">Ready to check in</div>
                     </div>
                 </div>
                 
                 <div className="space-y-2 mb-3">
                     <div className="flex justify-between items-center p-2 bg-neutral-50 rounded border border-neutral-100 gap-2">
                         <span className="text-[10px] text-neutral-500 shrink-0">Ticket</span>
                         <span className="text-[10px] font-mono font-bold text-neutral-700 truncate">T-8294-A1B2</span>
                     </div>
                     <div className="flex justify-between items-center p-2 bg-neutral-50 rounded border border-neutral-100 gap-2">
                         <span className="text-[10px] text-neutral-500 shrink-0">Holder</span>
                         <span className="text-[10px] font-medium text-neutral-700 truncate">John Doe</span>
                     </div>
                 </div>

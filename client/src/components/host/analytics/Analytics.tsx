      ...
      <main className="flex-1 lg:ml-64 pb-32">
        <div className="px-4 lg:px-8 pt-8 lg:pt-12">
          ...
          <div className="hidden lg:flex items-center gap-3">
              ...
              <button title='Dashboard' onClick={() => {router.push('/host/dashboard')}} className="p-2 transition-all text-neutral-400 hover:text-neutral-600 border border-slate-100 rounded-lg hover:bg-slate-50"><LayoutGrid size={18}/></button>

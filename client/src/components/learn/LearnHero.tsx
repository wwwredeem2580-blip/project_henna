  ...
  return (
    <div className="space-y-6 mb-12 border-b border-neutral-100 pb-12">
      ...
      <motion.div
        ...
        className="space-y-4"
      >
        <span className="inline-block px-3 py-1 rounded-full bg-brand-50 text-brand-600 text-[10px] font-bold uppercase tracking-widest border border-brand-100">
          {category}
        </span>
        <h1 className="text-3xl md:text-5xl font-light text-neutral-900 leading-[1.2] tracking-tight">
          {title}
        </h1>
        <p className="text-lg text-neutral-500 font-light leading-relaxed max-w-[1080px]">
          {subtitle}
        </p>

 ...
 * Sent to attendees after verifying their email.
 */

interface WelcomeUserPayload {
  name: string;
}

export function welcomeUserTemplate(payload: WelcomeUserPayload): string {
  const { name } = payload;
          ...
          <tr>
            <td style="padding: 48px 40px;">
              ...
              <p style="margin: 0 0 16px; color: #475569; font-size: 16px; line-height: 1.6; font-weight: 300;">
                We're thrilled to have you join the Zenvy community. Your account is now verified, and you're all set to discover amazing events.
              </p>
              ...
              <ul style="margin: 0 0 32px; padding-left: 20px; color: #475569; font-size: 16px; line-height: 1.6; font-weight: 300;">
                <li style="margin-bottom: 8px;">Browse upcoming events near you</li>
                <li style="margin-bottom: 8px;">Purchase tickets securely</li>
                <li style="margin-bottom: 8px;">Manage your bookings in one place</li>
              </ul>
              ...
              <table role="presentation" style="margin: 0 auto;">
                <tr>
                  <td style="border-radius: 8px; background: linear-gradient(135deg, #6366f1 0%, #8b5cf6 100%);">
                    <a href="${process.env.CLIENT_URL}/events" style="display: inline-block; padding: 16px 32px; color: #ffffff; text-decoration: none; font-size: 16px; font-weight: 500; border-radius: 8px;">
                      Explore Events
                    </a>
                  </td>
                </tr>
